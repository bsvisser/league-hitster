...
activeCard.innerHTML = <img src="${preloadedImg.src}" alt="${currentChampion.name}" class="card-image">
...
return <div class="card droppable ${isPlaced ? 'placed' : ''}" data-release-date="${champ.releaseDate}" data-index="${index}">
